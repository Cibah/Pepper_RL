...
def train(sess, env, args, actor, critic, actor_noise, update_model, saver):
...
def main(args):
    ...
    with tf.Session() as sess:
        ...
        if args['mode'] == 'INIT':
            train(sess, env, args, actor, critic, actor_noise, False, None)
        elif args['mode'] == 'TRAIN':
            saver = tf.train.Saver()
            saver.restore(sess, "ckpt/model")
            train(sess, env, args, actor, critic, actor_noise, True, saver)
        elif args['mode'] == 'TEST':
            saver = tf.train.Saver()
            saver.restore(sess, "ckpt/model")
            testDDPG(sess, env, args, actor, critic, actor_noise)
        else:
